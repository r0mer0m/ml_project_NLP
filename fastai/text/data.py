...
__all__ = ['LanguageModelLoader', 'SortSampler', 'SortishSampler', 'TextList', 'pad_collate', 'TextDataBunch',
           'TextLMDataBunch', 'TextClasDataBunch', 'Text', 'open_text', 'TokenizeProcessor', 'NumericalizeProcessor',
           'OpenFileProcessor', 'TextLabelerDataBunch', 'pad_collate_labeler']
...
class TextDataBunch(DataBunch):
    ...
    def from_df(cls, path:PathOrStr, train_df:DataFrame, valid_df:DataFrame, test_df:Optional[DataFrame]=None,
                ...
                label_cols:IntsOrStrs=0, label_delim:str=None, sep=',', **kwargs) -> DataBunch:
        ...
        elif str(cls)==str(TextLabelerDataBunch):# cls==TextLabelerDataBunch:
            src = src.label_for_labeler(sep=sep)
        else:
            src = src.label_from_df(cols=label_cols, classes=classes, sep=label_delim)
...
def str_to_int_list(labels:str, sep=','):
    labels = [int(element) for element in labels.split(sep)]
    return labels
...
class TextLabelerDataBunch(TextDataBunch):
    "Create a `TextDataBunch` suitable for training an RNN labelert."
...
class TextList(ItemList):
    ...
    def label_for_labeler(self,sep=','):
        self.__class__ = LabelerTextList
        # self._bunch = TextLabelerDataBunch
        return self.label_labeler(sep=sep)
...
class LabelerTextList(TextList):
    "Special `TextList` for a language model."
    _bunch = TextLabelerDataBunch
    # _is_lm = True
    _label_cls = EmptyLabel
